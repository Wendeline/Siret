function Search() {
    ...
    request.onloadend = function(){
        ...
        if (request.status !== 404){ //On vérifie si l'API ne renvoie pas une erreur 404
        ...
        //Si erreur 404
            ...
            DivResult.innerHTML = "Numéro SIRET non attribué ou éronné !"
        }
    }
}
